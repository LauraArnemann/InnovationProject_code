...
// Goal: Regular two-way fixed effects analysis with event studies on Czone level  
...
capture noisily graph export "$RESULTS/eventstudies/new_`type'_${dataset}/czone/var`var'_`explaining'_sample`i'_c1_balancednobin_`type'.png", replace
...
capture noisily graph export "$RESULTS/eventstudies/new_`type'_${dataset}/czone/var`var'_`explaining'_sample`i'_c2_balancednobin_`type'.png", replace
...
capture noisily graph export "$RESULTS/eventstudies/new_`type'_${dataset}/czone/var`var'_`explaining'_sample`i'_c3_balancednobin_`type'.png", replace
...
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c4_balancednobin_`type'.png", replace
...
capture noisily graph export "$RESULTS/eventstudies/new_`type'_${dataset}/czone/var`var'_`explaining'_sample`i'_c5_balancednobin_`type'.png", replace
} 
}
...
est sto reg1
coefplot reg1, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c1_balancedbinning_`type'.png", replace


ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' rd_credit pit cit ln_gdp unemployment `sample`i'', absorb(estab_id year) cl(estab_id)
est sto reg2
coefplot reg2, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c2_balancedbinning_`type'.png", replace

ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' rd_credit pit cit ln_gdp unemployment `other_controls' `sample`i'', absorb(estab_id year) cl(estab_id)
est sto reg3
coefplot reg3, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c3_balancedbinning_`type'.png", replace
...
est sto reg1
coefplot reg1, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c1_unbalancedbinning_`type'.png", replace


ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' rd_credit pit cit ln_gdp unemployment `sample`i'', absorb(estab_id year) cl(estab_id)
est sto reg2
coefplot reg2, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c2_unbalancedbinning_`type'.png", replace

ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' rd_credit pit cit ln_gdp unemployment `other_controls' `sample`i'', absorb(estab_id year) cl(estab_id)
est sto reg3
coefplot reg3, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c3_unbalancedbinning_`type'.png", replace

ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' `sample`i'', absorb(estab_id year#i.fips_state) cl(estab_id)
est sto reg4
coefplot reg4, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c4_unbalancedbinning_`type'.png", replace

ppmlhdfe `var' F?_change_`explaining' zero_1 L?_change_`explaining' `other_controls' `sample`i'', absorb(estab_id year#i.fips_state) cl(estab_id)
est sto reg5
coefplot reg5, vertical  levels(95)  recast(connected)  omitted graphregion(color(white)) xline(4.5, lpattern(dash) lwidth(thin) lcolor(black))  keep(F?_change_`explaining' zero_1 L?_change_`explaining') yline(0,  lcolor(red) lwidth(thin)) ylabel(,labsize(medlarge)) xtitle("Years since Change") graphregion(color(white))
capture noisily graph export "$RESULTS/eventstudies/new_`type'_$dataset/czone/var`var'_`explaining'_sample`i'_c5_unbalancedbinning_`type'.png", replace
} 
}
