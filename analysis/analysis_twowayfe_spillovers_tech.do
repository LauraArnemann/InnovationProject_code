...
local sample6 if inrange(year, 1988, 2018) & tag_local ==1  & total_patents>10
...
foreach expl of numlist 2  {
	...
	** Poisson regression
	...
	esttab regres15_p regres25_p regres16_p regres26_p using "${RESULTS}/tables/spillovers/var`var'_spillovers3_tech_p.tex", replace noconstant mtitles keep(`explaining') ///
				cells(b(star fmt(%9.3f)) se(par)) stats( estabfe stateyearfe othercontrols N, ///
